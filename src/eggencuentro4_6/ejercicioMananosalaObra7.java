 ...
 * @author Anabela
 */
public class ejercicioMananosalaObra7 {
...
o	Si no se cumple ninguno de los valores anteriores mostrar el mensaje “No existe un valor válido para tipo de bomba”
        ...
        */
        ...
        System.out.print("Ingrese un tipo de motor entre 1 y 4: ");
        ...
        switch (tipoMotor) {
            ...
            case 4:
                ...
                default :
                    System.out.println("El numero selecionado esta fuera de rango.");
